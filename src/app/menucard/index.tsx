...
// const VideoModal = ({ title , videoUrl, description, onClose }) => {
//   return (
...
//   const ItemCard = ({ title, imageUrl, item, handleCardClick }) => (
...
//   const handleCardClick = (item: { type: string; title: any; videoUrl: any; description: any; }) => {
//     if (item.type === 'coffee') {
